...
using EmployeeService.Authorization;
using EmployeeService.Configuration;
...
namespace EmployeeService
{
    ...
    {
        private const string ApiName = "Employees API"; 
        ...
        private static void AddSecurity(this SwaggerGenOptions options, string authenticationTokenEndPoint)
        {
            options.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme
            {
                Description = "JWT Authorization header using the Bearer scheme. Example: \"Authorization: Bearer {token}\" \n" +
                              $"Copy token from: <a href=\"{authenticationTokenEndPoint}\" target=\"_blank\">Get Bearer Token</a>",
